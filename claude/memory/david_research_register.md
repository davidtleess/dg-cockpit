...
|---|-----|-------|---------------|------------------|
| 1 | QB prediction research (`docs/strategies/2026-07-16-david-qb-prediction-research.md`) | 2026-07-16, committed d3c4534, pushed | 3-lane synthesis v3 (`2026-07-16-qb-research-synthesis.md`) | **ACTIVE** — fed QB-1 spec, now frozen at **v9** (SHA-256 `7fea58c75042…`) after the 07-20 D2a computability amendment; **slice 4 SHIPPED 07-20 (`2b25653`, CI 29799101472 green, pushed)**; next = registration document + study execution (both David-worded) |
...
| 5 | CollegeQB pre-draft model, writeup + backtest v0 (`docs/strategies/2026-07-17-david-collegeqb-predraft-model/` — `predraft-qb-model-writeup.md` + `qb_backtest.py`) | 2026-07-19 22:01, on disk (uncommitted) | **POINTER delivered to spokesperson 2026-07-19 ~22:1x (David's word: tonight's frontier sequencing must account for it — bears on QB thread + Engine A)** | Full disposition-read PENDING — comes as its own later David word; until then pointer-awareness only, no execution |
| 4 | Frontier & Edge brainstorm (`docs/strategies/2026-07-17-frontier-edge-brainstorm.md`) | 2026-07-19 11:04, on disk (uncommitted) | Delivered 2026-07-19 ~22:05 to all three crew panes unredacted; all three lanes dispositioned; consolidated three-lane packet issued 22:14 | **CLOSED 2026-07-20** — David ruled: wire posture **Option A** (H3/H4 redesigned wire-free, his explicit decision); Codex's granular ticket IDs adopted as board vocabulary; **EDGE-H1-00 executed and COMPLETE** (4 seasons, 173 snapshots, draft committed in `7ef75f7`). Remaining frontier tickets (EXAM-1/SCOUT-1/TAPE-1/EDGE-H1-10/EDGE-H1-20/UX-H5-20/RECAP-1) sit on the board, each David-gated. STUDIO still EXCLUDED (governance-saturated — clean paraphrased briefs only when H5 opens) |
