...
## Project state
- [**Season readiness sprint 2026**](project_season_readiness_2026.md) — **kickoff 2026-09-10, freeze FRIDAY 09-04.** D7 (08-29, first-real-user day + night session): DG-086/087/089 landed+live, SR-19 rehearsed, sitting done; **NIGHT: DG-092/SR-13 landed (Wed D9 FREED), DG-090-A landed, SR-09 amendment pushed — sprint tail is now ONLY Tue 09-01: 15-min check + 5-min SR-09 done-mark; everything after is buffer.** DG-091 brief drafted + rewritten around DAVID'S PROSE RULING; mail-carrier zombie retired. **⚠ daily-open axe gate is NONDETERMINISTIC (coin-flip on `npx playwright test` on main until DG-091 retires the debt — never exclude the contrast rule).** **DO NOT edit XVAR_LAMBDA_ENGINE_B (retracted; DG-092 now guards it in code)**; git ahead/behind was once reported inverted — left is behind, right is ahead.
