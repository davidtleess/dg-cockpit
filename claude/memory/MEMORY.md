...
## Project state
- [**Season readiness sprint 2026**](project_season_readiness_2026.md) — **kickoff 2026-09-10, freeze 09-04.** **D5 (08-27): DG-045/SR-09 LANDED `4048f25a` + launchctl swap DONE (12 labels; session hands on David's remote word)** — step 8/SR-19 stays D8; approved architecture plan + amendments Rev 2; **DO NOT edit XVAR_LAMBDA_ENGINE_B (retracted finding)**; git ahead/behind was reported inverted all session.
