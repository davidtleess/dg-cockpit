...
## Project state
- [**Season readiness sprint 2026**](project_season_readiness_2026.md) — **kickoff 2026-09-10, freeze 09-04.** **D5: DG-045 landed + swap done; D6 (08-28): FOUR lands on David's remote panel — DG-082 guard idle-doze fix (proven 09:02), DG-083/SR-10a, DG-084/SR-14 (fabrication check Wed 09-02!), DG-020 (4→480 market dates); NIGHT: FIVE more lands (DG-028/050/054/057/085 — guard sees serving, replay harness live, normalizer v1, spec-hash refusal) + DG-017 falsifier FIRED (attribution is fit-dependent — never quote coefficient shares as what-drives-production)** — SR-19/D8 + SR-12/SR-13 remain; approved architecture plan + amendments Rev 2; **DO NOT edit XVAR_LAMBDA_ENGINE_B (retracted finding)**; git ahead/behind was reported inverted all session.
