---
name: dg-status
description: Report the current Dynasty autonomy run's goal, scope, phase, checks, changes, blocker, and human gate. Use when the user asks {{HOST}} for progress or whether an engineering run is ready.
---
