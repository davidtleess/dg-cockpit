---
name: dg-review
description: Review an autonomous engineering worktree and its evidence for correctness, safety, scope, and real-surface behavior. Use when the user asks Claude to assess changes before a human commit or publication gate.
---
