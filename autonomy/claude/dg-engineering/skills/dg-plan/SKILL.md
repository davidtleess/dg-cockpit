---
name: dg-plan
description: Inspect an authorized engineering goal and write an exact, test-first implementation plan without editing product code. Use when the user asks Claude to plan Dynasty Genius work or reduce ambiguity before execution.
---
